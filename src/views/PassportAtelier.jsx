...
export default function PassportAtelier() {
  ...
  return <><SiteHeader /><main ref={pageRoot} className={`pa-page pa-fit${expanded ? ' pa-expanded' : ''}`}>
    ...
    {data && <>
      ...
      {data.sticker?.eligible && !data.sticker.given_at && <Notice>ครบ {data.sticker.at} ดวงแล้ว รับสติกเกอร์ Passport ได้ที่โต๊ะพี่ ๆ ในงานถัดไป</Notice>}
      {data.sticker?.given_at && <p className="pa-note">คุณรับสติกเกอร์ Passport แล้ว ♡</p>}
