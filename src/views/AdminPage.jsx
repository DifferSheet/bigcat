...
function EventAdmin({ ev, refresh, onEdit, onDeleted }) {
  ...
  return <div className="admin-event">
    <div className="admin-event-head">
      ...
      {ev.type !== 'fanmeet' && <Link className="button ghost small" to={`/events/${ev.slug}/gate`} title="เปิดบนมือถือ/iPad แล้ววางที่จุดเช็คอิน — ใช้เมื่อตั้ง «เช็คอินหน้างาน» เป็น สแกน QR หน้างาน">จอ QR เช็คอิน</Link>}
