...
cfg.gallery = ['/images/events/merit-vassa-2026-schedule.jpg'];   // สไลด์ภาพที่ 2 ต่อจากปก
await q('UPDATE events SET config=?, cover=?, ends_at=? WHERE id=?', [JSON.stringify(cfg), '/images/merit-vassa-2026.webp', '2026-09-19 12:00:00', ev.id]);
console.log('✓ config: ปิดยอด 17 ก.ย. 23:59 · FAQ · นโยบายยอดเกิน · กำหนดการ 6 ช่วง · สไลด์กำหนดการ');
