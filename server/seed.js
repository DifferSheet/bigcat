...
const events = [
  ...
  },
  {
    ...
    starts_at: '2026-09-19 09:00:00', ends_at: '2026-09-19 12:00:00', cover: '/images/events/merit-vassa-2026-schedule.jpg',
    config: {
      ...
      donateUntil: '2026-09-17 23:59:59',
      ...
      schedule: [['09:30', 'ถวายเพลพระ 5 รูปแบบส่วนตัว พร้อมถวายสังฆทาน ผ้าไตรจีวร ข้าวสาร น้ำดื่ม และของใช้ให้ทางวัด'], ['10:15', 'แต่งต้นกฐินสามัคคี พี่บูตะ & มัมป๊าร่วมกัน'], ['10:30', 'ถวายเพลพระเณรทั้งวัด 92 รูป และต้นกฐิน พร้อมคุณตา ร่วมกับเจ้าภาพคนอื่น ๆ (ศาลาใหญ่)'], ['11:00', 'Hi-touch รับขนมและของวิเศษจากบูตะ (แก้ว / หินมงคล + น้ำมนต์ 9 วัด)'], ['11:10', 'ลูกบูนอนพัก'], ['11:40', 'พูดคุย จับมือ จับพุง ถ่ายรูปหมู่ รูปคู่ รูปเดี่ยว · พามัมป๊าเข้าไปสถิตอธิษฐานจิตพร้อมกันก่อนกลับบ้าน']],
      faq: [['ไปวัดอย่างไร', 'วัดวชิรธรรมสาธิต ซอย 101/1 เข้าซอยสุดซอยตรง 3 แยกเลี้ยวซ้าย กดที่ชื่อสถานที่เพื่อเปิดแผนที่'], ['มาไม่ได้ร่วมบุญได้ไหม', 'ได้ เลือกหมวดที่ต้องการแล้วแจ้งยอดพร้อมสลิปได้ในหน้านี้ ปิดรับยอดออนไลน์ พฤหัส 17 ก.ย. เที่ยงคืน'], ['ได้ใบอนุโมทนาไหม', 'ได้ ระบบออกใบอนุโมทนาดิจิทัลให้หลังยืนยันยอด บันทึกเป็นภาพแชร์ได้'], ['ยอดขึ้นเมื่อไหร่', 'ถ้าแนบสลิปแล้วระบบตรวจผ่าน ยอดขึ้นทันที ถ้าไม่ผ่าน พี่ ๆ ที่ดูแลจะตรวจให้ภายใน 24 ชั่วโมง']],
    },
