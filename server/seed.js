...
const events = [
  {
    ...
    config: {
      ...
      schedule: [['10:00', 'เปิดประตู · รับของที่ระลึก'], ['11:00', 'Talk กับทีมโนบิ'], ['13:00', 'Photo session โซน Nobi'], ['15:30', 'Mini game & ลุ้นรางวัล'], ['17:00', 'Group photo ปิดงาน']],
  ...
  },
  {
    ...
    config: {
      ...
      report: {
        accountNote: 'บัญชีรับเงินเป็นบัญชีของทีม Bigcat ที่ทำหน้าที่รวบรวมยอดแทนแฟนคลับ ไม่ใช่บัญชีของวัด',
      ...
      faq: [['ไปวัดอย่างไร', 'วัดวชิรธรรมสาธิต ซอย 101/1 เข้าซอยสุดซอยตรง 3 แยกเลี้ยวซ้าย กดที่ชื่อสถานที่เพื่อเปิดแผนที่'], ['มาไม่ได้ร่วมบุญได้ไหม', 'ได้ เลือกหมวดที่ต้องการแล้วแจ้งยอดพร้อมสลิปได้ในหน้านี้ ปิดรับยอดออนไลน์ 18 ก.ย. 20:00 น.'], ['ได้ใบอนุโมทนาไหม', 'ได้ ระบบออกใบอนุโมทนาดิจิทัลให้หลังยืนยันยอด บันทึกเป็นภาพแชร์ได้'], ['ยอดขึ้นเมื่อไหร่', 'ถ้าแนบสลิปแล้วระบบตรวจผ่าน ยอดขึ้นทันที ถ้าไม่ผ่านทีมงานตรวจภายใน 24 ชั่วโมง']],
    },
